...
const getallhistory = (user_id) => new Promise((resolve, reject) => {
  if (user_id === 1) {
    connection.query(
...
const showHistory = (rental_id) => new Promise((resolve, reject) => {
  connection.query(
...
const deleteHistory = (rental_id, deleteBy) => new Promise((resolve, reject) => {
